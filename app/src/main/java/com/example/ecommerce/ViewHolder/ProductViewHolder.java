...
public class ProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public ProductViewHolder(@NonNull View itemView) {
       ...
       //  productdesc = itemView.findViewById(R.id.product_disc_item);
       productprice = itemView.findViewById(R.id.product_price_item);
        productimage = itemView.findViewById(R.id.product_image_item);
