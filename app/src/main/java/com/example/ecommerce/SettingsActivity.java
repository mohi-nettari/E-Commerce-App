...
public class SettingsActivity extends AppCompatActivity {
   ...
   private CircleImageView proimage_s;
    private EditText phone_s,name_s,adress_s;
    private TextView close_s  , changeproimage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserInfoDisplay(proimage_s , phone_s , name_s ,adress_s);
...
//                        FirebaseUser firebaseUser = FirebaseAuth.getInstance().getCurrentUser();
    ...
    private void UserInfoDisplay(CircleImageView proimage_s, EditText phone_s, EditText name_s, EditText adress_s)
    {
